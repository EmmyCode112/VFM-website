...
const SignUp = () => {
  ...
  return (
    <div className="flex h-[100vh] w-full signup overflow-hidden">
      <div className="image">
        <img src="./login-img.png" className="w-[80%] h-[100vh]" alt="" />
      </div>
        ...
        {joined ? (
          <div className="thanks-message flex flex-col items-end pr-[77px] pt-[51px] gap-[200px]">
            <div className="logo absolute">
              <Link to={"/"}>
                <img src="vfm LOGO.png" alt="" />
              </Link>
            </div>
            <div className="flex flex-col gap-[43px] justify-center h-[80vh] items-center text-center">
              <h2 className="text-[40px] w-[90%] font-[500] leading-[59px]">Thank you for joining the VFM waitlist! 🌟</h2>
              <p className="text-[18px] font-[400]" >
                You're now part of an exclusive group that will be among the
                first to experience the magic of Afyaa. 🚀
              </p>
              <Link to={'/'}><button className="w-[60%] btn bg-[#91be1d] h-[99px] rounded-[20px]">Go to Homepage</button></Link>
            </div>
          </div>
        ) : (
          <>
            <p className="mt-[89px] mb-[55px] text-center text-[30px] leading-[33px] font-[400]">
              Welcome to VFM
            </p>
            <div className="flex flex-col gap-[60px]">
              <form className="flex flex-col gap-[35px] text-center">
                ...
                <button className="btn" type="submit">JOIN WISHLIST</button>
              </form>
